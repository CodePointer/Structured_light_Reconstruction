for itr_idx = 1:max_iter_num
    ...
    if itr_idx == 1
        ...
        depth_coarse_vec = fun_dCoarse2FineDepth(d_depth_coarse_vecs{frm_idx,1}, ...
            depth_fine_vecs{frm_idx-1,1}, ProInfo);
        test_d_depth_coarse_vec = d_depth_coarse_vecs{frm_idx,1};
        test_depth_coarse_vec = depth_coarse_vec;
        d_error = NaN;
    else
        ...
        cam_est_derv = fun_CoarseEstCamImageDerv(cam_est_vecmat, ...
            ...
            C_fine, ...
            ParaSet);
        norm_derv_vec = fun_CoarseErrorFunctionDerv(cam_est_vec, ...
            cam_obs_vecs{frm_idx,1}, ...
            cam_est_vecs{frm_idx-1,1}, ...
            cam_obs_vecs{frm_idx-1,1}, ...
            cam_est_derv, ...
            d_depth_coarse_vecs{frm_idx,1}, ...
            theta, ...
            ParaSet);
    ...
    if (itr_idx==1) || ((itr_idx>=2) && (d_error<0))
        ...
        depth_coarse_vec = test_depth_coarse_vec;
        depth_coarse_vecs{frm_idx,1} = depth_coarse_vec;
