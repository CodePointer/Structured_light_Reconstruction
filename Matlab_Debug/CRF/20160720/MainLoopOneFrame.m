...
for frame_idx = start_frame_num+1:data_frame_num
    % Initial
    ...
    tmp_depth_mat = GetDepthFromBeliefField(beliefField, ...
        ...
        voxelSize, ...
        halfVoxelRange);
    save(['depth_mat/', 'frame_', num2str(frame_idx), '_iter_', '0', '.txt'], 'tmp_depth_mat');
    ...
    for iter_idx = 1:10
        ...
        tmp_depth_mat = GetDepthFromBeliefField(beliefField, ...
            ...
            voxelSize, ...
            halfVoxelRange);
        save(['depth_mat/', 'frame_', num2str(frame_idx), '_iter_', num2str(iter_idx), '.txt'], 'tmp_depth_mat');
        writepointcloud(tmp_depth_mat, ...
            camMat, ...
